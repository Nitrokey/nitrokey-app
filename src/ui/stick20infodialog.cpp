...
void Stick20InfoDialog::showStick20Configuration (void)
{
    ...
    {
        OutputText.
            append (QString (" ***  Warning: Device is not secure  ***")).
            append ("\n");
        OutputText.
            append (QString (" ***       Select -Init keys-        ***")).
            append ("\n").append ("\n");
    }
    ...
    {
        OutputText.append (QString ("Unencrypted volume   READ/WRITE mode ")).
            append ("\n");
    }
    else
    {
        OutputText.append (QString ("Unencrypted volume   READ ONLY mode ")).
            append ("\n");
    }
    ...
    {
        OutputText.append (QString ("Encrypted volume     active")).
            append ("\n");
    }
    else
    {
        OutputText.append (QString ("Encrypted volume     not active")).
            append ("\n");
    }
    ...
    if (0 == (HID_Stick20Configuration_st.SDFillWithRandomChars_u8 & 0x01))
    {
        OutputText.
            append (QString
                    (" *** Storage is not initialized with random data ***\n"));
    }
