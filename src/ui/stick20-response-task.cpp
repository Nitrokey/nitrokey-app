...
Stick20ResponseTask::Stick20ResponseTask (QWidget * parent,
                                          Device * Cryptostick20,
...
QString OutputText;
    ...
    if (0 == retStick20Respone)
    {
        ...
        {
            ActiveCommand =
                stick20Response->HID_Stick20Status_st.LastCommand_u8;
        }
        ...
        if (OUTPUT_CMD_STICK20_STATUS_OK ==
